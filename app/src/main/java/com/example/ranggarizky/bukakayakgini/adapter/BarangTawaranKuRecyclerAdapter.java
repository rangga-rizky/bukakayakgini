 ...
 */
public class BarangTawaranKuRecyclerAdapter extends RecyclerView.Adapter<BarangTawaranKuRecyclerAdapter.MyViewHolder> {
    ...
    public BarangTawaranKuRecyclerAdapter(Context context, List<Tawaran> data) {
        this.data = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_barang_tawaran_ku, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        switch (item.getStatus()){
            case "3" :
                ...
                holder.txtStatus.setText("Ditandai");
                break;
            case "4" :
