 ...
 */
public class RequestInterestSquareRecyclerAdapter extends RecyclerView.Adapter<RequestInterestSquareRecyclerAdapter.MyViewHolder> {
    ...
    public RequestInterestSquareRecyclerAdapter(Context context, List<RequestObject> verticalList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_interest_request, parent, false);
