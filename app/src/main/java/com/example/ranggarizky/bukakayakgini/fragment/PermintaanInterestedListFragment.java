 ...
 */
public class PermintaanInterestedListFragment extends Fragment {
    ...
    public PermintaanInterestedListFragment() {
    ...
    private void loadData(){
        ...
        Call<ResponsePermintaan> call = apiService.fetchInterestRequest(sessionManager.getUid(),"ant0k","1","50");
